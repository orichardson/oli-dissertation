...
\bibliographystyle{plainnat}
	\setcitestyle{citesep={;},aysep={},open={[},close={]}}
	% \setcitestyle{citesep={;},aysep={,},open={(},close={)}}
...
\newcommand\forjoe[1]{{\color{red}Note for Joe: #1}}
% \newcommand\forjoe[1]{}
% \newcommand{\newmaterial}[1]{{\color{violet}#1}}
\let\newmaterial\relax
\let\oldnewmaterial\relax
\newcommand{\overkill}[1]{{\color{gray!50!white}#1}}
...
\hypersetup{colorlinks=true, linkcolor=blue, urlcolor=magenta, citecolor=Emerald!50!deepgreen}
% \usepackage{parskip}
...
\newcommand\XEnt{\mathrm{CrossEntropy}}
...
\relax % Short arrows.
	...
	%     {\hbox{\rule[-.5\fontdimen8\textfont3]{#1}{\fontdimen8\textfont3}}}%
	...
	% \let\sto\veryshortarrow
	\newcommand\sto{\mathchoice{{\to}}{\veryshortarrow}{\scriptveryshortarrow}{{\to}}}
    ...
    \newcommand\stogreen{{\color{green!70!black}\sto}}
    ...
    \newcommand\stoblue{{\color{blue}\sto}}
...
\usepackage[nobox,strip]{restatelinks}
...
% 
	...
	\tikzset{lirfactor/.style={draw,minimum width=1.5em, minimum height=1.5em,fill=gray!50!black,text=white,font=\mathversion{bold}\bfseries}}
