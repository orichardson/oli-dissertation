...
% As illstrated in \cref{chap:one-true-loss},
...
The main tool of this chapter is a parametric version of a PDG. 
For this reason, we
% \paragraph{Geometry.}
...
will need various parameter spaces $\Theta$.
...
We now formally introduce an equally expressive \emph{parametric} variant of a PDG,
    that was first mentioned in \cref{sec:alt-pdgs}.
