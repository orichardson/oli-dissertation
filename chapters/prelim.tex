...
When $\V\!X$ is a subset of real space $\mathbb R^n$, we use the \emph{Lebesque measure}, which agrees with the standard notions of length, area, and volume.
}%


% At a technical level,
All of this new structure is compatible with our discussion of variables in \cref{ssec:basic-vars}.
This is sbecause all of our ways of constructing variables---through (indexed) sets of variables, and by applying functions---work equally well over measurable spaces
\newmaterial{(with a base measure)}.
\begin{enumerate}
\item
...
The analogue of the random variable $p(Y|X)$ in the finite case 
    is the 
    measurable function 
\[
