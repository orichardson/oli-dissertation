...
These two views of a hypergraph correspond directly to two (dual) ways of notating a process: as a \emph{flowchart} or as a \emph{circuit} \citep{kasangian1990duality}.
...
In either representation, the two hypergraphs on the left represent real

\TODO

Both representations are commonly used in AI. 
% The neural network ``architecture diagrams'', are the most common way to visually communicate the architecture of
In machine learning, the circuit representation has become the standard way to communicate the operations in a neural network, and it is called a ``architecture diagram''.
