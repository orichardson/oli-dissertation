...
Aside from these unwelcome developments, this analogue of entropy acts otherwise just like the original, but shifted by an additive constant.  
...
Fortunately, (conditional) mutual information works just as before: it is non-negative and zero iff there is a (conditional) independence. 
}
