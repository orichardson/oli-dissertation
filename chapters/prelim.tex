...
An recurring theme in the attacks is the dependence on representation---
}
...
One contribution of this thesis is to expand the principle of maximum entropy to account for qualitative information (\cref{sec:bn-maxent}). 
%
...
One reason is that we do not need to know anything about $\V\!X$ in order make full use of these quantities.
...
% Indeed, it makes no sense to feed $(x,y) \in \V(X,Y)$ as an argument to any of these concepts, even if we wanted to.
