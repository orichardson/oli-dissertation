...
\newmaterial{%
Moreover, by appealing only to beliefs (which are subject to analysis and revision) and this one particularly special value, we can still 
    %  much of the current practice of artificial intelligence can be done .
    recover the core elements of modern artificial intelligence (as shown in \cref{chap:one-true-loss,chap:LIR}). 
