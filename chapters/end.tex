...
For instance, the principle of maximum entropy suggests
    ...
    this variant appears to have an even closer relationship with $\SDef$.
}%
...
another artifact of this research progrm has been general-purpose Python library implementing the framework in the discrete case
...
The impact of this may be even larger, considering the current context. 
...
can we really trust an inhumanly clever psychopath to maximize some metric of profit, productivity, or happiness? 
