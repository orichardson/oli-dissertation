...
% How should you 
We have just seen how we can reason about PDGs from the outside, but a lot of probabilistic reasoning can be done \emph{internally} within PDGs.  In \cref{chap:one-true-loss} we saw how many important inequalities in the literature are instances of what we called \emph{monotonicity of inconsistency}: believing more things can only make you more inconsistent, not less.
