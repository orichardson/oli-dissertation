...
\commentout{%oli-v1
	...
	This chapter details a different conception that arises when updating beliefs.
...
% The present chapter, and the general notion of confidence we formalize in \cref{sec:updateformalism}
% The notion of confidence we present in this chapter
...
In richer settings, a more nuanced degree of confidence 
    ...
    \parencite{kappa},
    or
%TODO: get better citation; that chapter focuses on something more
...
% At the heart of our chapter is a hierarchy
%
...
% The rest of this chapter is develops the theory of confidence,
...
\commentout{
	...
	% This chapter can be a generalization of Shafer's ``weight of evidence'' to a broader class of settings, where one might have very different belief states and observations.
...
\begin{subappendices}
    ...
    % Having said that, one reading of this chapter is a relaxation of this requirement.
...
\commentout{
    ...
    On its own, so long as we have the freedom to choose $\confdom$, \Cref{ax:combinativity} has no teeth.
