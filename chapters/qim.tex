...
\subsection{The Equivalence Between \SCibility\ and Solving a Randomized PSEM}
...
We now formally introduce the qualitative PDG scoring function $\SDef$, which interprets a hypergraph structure $\Ar$ as a function of the form $\mat I_\mu \cdot \mat v_{\!\Ar}$.
...
While $\SDef$ has some nice properties\footnote{%
...
\commentout{%
Nevertheless, if $\mu\models \Ar$, we prove that $- \SDef_{\Ar}(\mu) = \mat v_{\!\Ar} \cdot \mat I_\mu \ge 0$. 
