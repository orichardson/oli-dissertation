...
\TODO[ FIX can-arise type problem below]
...
\begin{lproof}
    ...
    % For the reverse direction, suppose that $\mu \in \Delta \Omega$ satisfies
    ...
    Following \citet[Theorem 2.6.1]{halpern-RAU}, let $\mathcal P_\Bel := \{ \mu \in \Delta \Omega : \Bel(U) \le \mu(U) \le \Plaus(U)$ for all $U \subseteq \Omega \}$. 
    \unskip\footnote{For observant readers who followed the reference: the second condition is redundant, so this really is the same definition as in \cite{halpern-RAU}.}
