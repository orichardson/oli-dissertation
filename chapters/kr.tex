...
%
It is well-known that different representations can change the result of maximizing entropy. But some representations better capture a scenario more naturally than others, and PDGs make it easy to select representations that interact appropriately with entropy. 
}
\end{example}
