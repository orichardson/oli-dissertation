...
Despite its dominance, probability has shortcomings, and it is not the only tool we have for representing knowledge and uncertainty \citep[\S2]{halpern-RAU}.
% Possibility is one important one; others include belief/plausibility measures, which have been touted as generalizations of probability. 
% Perhaps surprisingly, many of these objects can be represented with PDGs as well.
...
% Indeed, it appears impossible to obtain a representation 
% that leads 50/50 maximum entropy presumption when using a PDG.
...
\forjoe{This is not my priority; if it gets done that would be great, but there are other more improtant things at the moment. If I don't have time to do this properly, I will delete this at the end; no need to highlight it. }
}%
