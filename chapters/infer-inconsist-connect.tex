...
\newmaterial{%
    % This 
The result is a deep and rather philosophical conclusion: precisely quantifying the degree of one's inconsistency is no easier than optimally resolving those inconsistencies. 
}%
...
\shortintertext{\centering
    ...
    derivative.\footnotemark)
        ...
        &= \Big( \Cancel{\nabla_\mu
            ...
            \\
        &= \frac{\partial}{\partial p} \kldiv{\mu^*_p(Y{=}y)}{p}
        & \mathllap{\text{by \eqref{eqn:matching-gradients-at-optimum}}}.
    \end{align*}
