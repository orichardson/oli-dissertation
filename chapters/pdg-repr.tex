...
\begin{enumerate}[wide, label={\textbf{PDG Variant \arabic{*}:}}]
    ...
    \textbf{PDGs with adaptive confidences, missing values, and probability ranges.}
	...
	%
    More generally, one might imagine a variant in which one needn't specify a complete conditional probability table, but could leave some entries blank---or, instead of a single conditional probability, one might want to specify a range of possible values. 
