...
The foundational \newmaterial{principles} of microeconomics
...
as the gold standard for representing beliefs \citep{ramsey1926truth}.
...
Modern ideals of ``good code'' agree: it is better to eliminate the potential for conflict by design, than it is to handle inconsistency at while the code is running. 
%
...
\newmaterial{%
rendering our systems invulnerable to
...
We would like to have theorems stating that two different approaches give the same answer---but 
    ...
    the representation itself cannot guarantee that the two views are redundant; without the proof of the theorem, they may well instead have been inconsistent. 
}%
