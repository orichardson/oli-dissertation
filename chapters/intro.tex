...
Correspondingly, our representations representations (and tools for manipulating them)
    strive for two oposing virtues:
...
\newmaterial{%
Some readers might immediately recognize this division; others may find it confusing or find it to be a false equivalence. 
By the end of the thesis, hopefully we will gain some appreciation
...
for this analogy and its role of this concept in probabilistic modeling. 
}%    
