...
The \emph{universal objective} 
    % at hand
    that is the subject of \cref{part:univ-objective}
...
% \item 
% The way we measure inconsistency is principled and does not require arbitrary choices. Every aspect of the formula is well-motivated, and can be defended both axiomatically. 
\end{enumerate} 
...
%     why it makes sense for it to be universally revialed (sense 2) what enables it to be used in practice (meaning 3).
