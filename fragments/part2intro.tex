...
\newmaterial{%
    effectively positioning inconsistency as a ``universal loss function''.
}%
...
can be viewed as approaches to inconsistency minimization
    (\cref{chap:LIR}),
    \commentout{%
    and so minimizing inconsistency is a ``universal objective'' in that
    the most celebrated algorthms in AI
    can be viewed as approaches to inconsistency minimization.
    }%
    % some key algorithms in AI
    % many key of the most important algorithms in AI
    % hese algorithms can be derived as approaches to minimizing inconsistency.
\newmaterial{%
    revealing inconsistency to be a ``universal objective'' underlying key algorithms in AI. 
}%
