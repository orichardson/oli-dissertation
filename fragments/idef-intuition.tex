...
%			\useasboundingbox (current bounding box);
	...
	% The components of each Venn diagram 
	% Each circle represents a variable; 
	% an area in the intersection of circles $\{C_j\}$ but outside of circles $\{D_k\}$ corresponds to information that is shared between all $C_j$'s, but not in any $D_k$. 
	% The components of each diagram correspond to 
	...
	% Variation of a candidate distribution $\mu$ in a
